...
class tutorialScreen4 extends ConsumerStatefulWidget {
  const tutorialScreen4({Key? key}) : super(key: key);

  @override
  _screen4State createState() => _screen4State();
}

class _screen4State extends ConsumerState<tutorialScreen4>
  ...
  Widget build(BuildContext context) {
    ...
    final pushButton7 = TextButton(
      ...
      onPressed: () {
        context.go('/tutorial');
        ref.read(tutorialProvider.notifier).setTutorial(4);
      },
      child: const Text(
        '〇',
