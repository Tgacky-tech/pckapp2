        ...
        Padding(
          ...
          child: GridView.count(
            ...
            children: <Widget>[
              ...
              _dialog('19',
                  '悪質なアカウントが不在配達を装ってSMS（ショートメッセージサービス）を送ってくることはよくあることです。ID・パスワードは絶対に入力してはいけません。'),
              _dialog('20',
                  'SMS（ショートメッセージサービス）には怪しいアルバイトの求人などが届くこともあります。犯罪絡みのものも多いため絶対に、リンクを開いたりしないでください。'),
              _dialog('21',
                  '突然知らない番号から電話がかかってきても、慌てないようにしましょう。相手の電話番号を調べるなどして、安全だという確証が得られてからかけなおせばよいだけです。'),
              ...
              _dialog('23',
                  '画像にタグ付けされたユーザー名と投稿しているアカウントのユーザー名が違います。無断転載している可能性があります。'),
              _dialog('24',
                  'ユーザー名をよく見ると本来の公式アカウントのユーザー名と少し違います。また、認証マークの色も違います。公式のなりすましのアカウントである可能性が高いです。'),
              _dialog('25', 'フェイクニュースです。インターネットの情報はうのみにしないようにしましょう。裏取りが大切です。'),
              _dialog(
                  '26', '知らないアカウントからのとつぜんのDMには注意しましょう。まずは、相手をじっくりと精査しましょう。'),
              Text(''),
              Center(
                child: Text(
                  'Web',
              ...
              _dialog('27',
                  'アドレスバーに注意信号が出ていますが、これはウェブサイトのデータの中にSSL暗号化していない情報が含まれているということです。この状態のウェブサイトでは簡単に情報が抜き取られてしまいます。'),
              _dialog('28',
                  'パスワードが簡単すぎます。しっかり指示に従って、強力なパスワードを使用してください。使いまわしも避けるべきでしょう。'),
              _dialog('29',
                  'パスワードの確認がなく、住所を入力するフォームに代わっています。パスワードの確認フォームがない場合、タイプミスしていたときにログインできなくなります。'),
              ...
              _dialog('32',
                  '画面がオフになっている間に大量のバッテリーが消費されています。隠しアプリがインストールされている可能性もあります。怪しいと思ったらすぐに専門家に相談しましょう。'),
              _dialog('33',
                  'よくわからいアプリが多くのバッテリーを消費しています。怪しいと感じたら。一度アンインストールしてみましょう。'),
              //           Center(
              //             child: Text(
              //               'phone',
              //                   style: TextStyle(
